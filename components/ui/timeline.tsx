  ...
  return (
    ...
    >
      ...
      <p className="text-center text-base font-normal text-neutral-300 md:text-lg">
       A look into my academic background and the milestones that shaped my growth.
      </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-orange-300 via-yellow-300 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
